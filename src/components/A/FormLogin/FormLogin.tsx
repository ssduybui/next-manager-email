...
import { setAccessToken } from "@/utils/clientToken";
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        if (json.statusCode === 400) {
                            ...
                            signIn('credentials', { name: json.data.user_fullname, email: json.data.user_name });
                        }
                    }
                } catch (error) {
                    setProcessing(false);
    ...
    return (
        <>
            ...
            >
                ...
                <ButtonPrimary type="submit" disabled={processing || completed ? true : false}>
                    {processing ?
                        <div role="status">
